            ...
            <div class="container"><a class="navbar-brand font-bold" href="index.html">PingCamping</a>
                ...
                <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base align-items-lg-center align-items-start">
                        ...
                        <li class="nav-item px-3 px-xl-4"><a class="nav-link fw-medium" aria-current="page" href="<?= base_url('Web/profil_home')  ?>">Home</a></li>
                        <li class="nav-item px-3 px-xl-4"><a class="nav-link fw-medium" aria-current="page" href="<?= base_url('Web/profil')  ?>">Profil</a></li>
                        <li class="nav-item px-3 px-xl-4"><a class="nav-link fw-medium" aria-current="page" href="<?= base_url('Web/sewa')  ?>">Sewa</a></li>

                        <li class="nav-item px-3 px-xl-4"><a class="btn btn-outline-dark order-1 order-lg-0 fw-medium" href="<?= base_url('Login/logout')  ?>">Logout</a></li>
                            ...
                            <div class="card overflow-hidden shadow"> <img class="card-img-top" style="width: 500px; height: 300px; object-fit: cover" src="<?= base_url('public/assets/img/barang/' . $value['gambar'])  ?>" alt="Rome, Italty" />
                                <div class="card-body py-4 px-3">
                                    <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                                        <h4 class="text-secondary fw-medium"><a class="link-900 text-decoration-none stretched-link" href="<?= base_url('Web/profil_detail_barang/' . $value['id_barang'])  ?>"> <?= $value['nama_barang'] ?></a></h4><span class="fs-1 fw-medium">Rp. <?= number_format($value['harga_sewa'], 0, ',', '.')  ?> / Hari</span>
                                    </div>
